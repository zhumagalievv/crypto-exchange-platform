...
const budgetting = fadeIn('.budgeting-page .headers__img', '.budgeting-page .headers__img img', 200, 0.25)
...
//commodities 
const commodities = fadeIn('.commodities .commodity-small-text-img', '.commodities .commodity-small-text-img img', 100, 0.3)
// money-box
const money_box = fadeIn('.money-box .commodity-small-text-img', '.money-box .commodity-small-text-img img', 100, 0.1)
// market-place
...
const split_a_bill = fadeIn('.split-bill-page .headers__img', '.split-bill-page .headers__img img', 450, 0.1)

const early_salary = fadeIn('.early-salary-page .headers__img', '.early-salary-page .headers__img img', 250, 0.2)



const subscriptions_page = fadeIn('.subscriptions-page .headers__img', '.subscriptions-page .headers__img img', 250, 0.3)
